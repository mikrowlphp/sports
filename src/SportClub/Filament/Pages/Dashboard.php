...
use Packages\Sports\SportClub\Filament\Widgets\EventsCalendarWidget;

/**
 * Sport Club Dashboard
 *
 * Main dashboard for the Sport Club module showing upcoming events and activities
 */
class Dashboard extends Page
{
    ...
    {
        return 1; // Full width for calendar
    }

    public function getTitle(): string|Htmlable
    {
        return static::$title ?? __('Sport Club Dashboard');
    }
